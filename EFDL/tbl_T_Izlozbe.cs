...
namespace EFDL
{
    ...
    public partial class tbl_T_Izlozbe
    {
        public tbl_T_Izlozbe()
        {
            this.tbl_Izlozbe_odrzavanja = new HashSet<tbl_Izlozbe_odrzavanja>();
            this.tbl_Izlozbe_organizatori = new HashSet<tbl_Izlozbe_organizatori>();
        ...
        public virtual ICollection<tbl_Izlozbe_organizatori> tbl_Izlozbe_organizatori { get; set; }
