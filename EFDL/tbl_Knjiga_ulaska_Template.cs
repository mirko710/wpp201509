...
namespace EFDL
{
    ...
    public partial class tbl_Knjiga_ulaska_Template
    {
        public tbl_Knjiga_ulaska_Template()
        {
            this.tbl_KUL_brojevi = new HashSet<tbl_KUL_brojevi>();
        }
        ...
        public virtual ICollection<tbl_KUL_brojevi> tbl_KUL_brojevi { get; set; }
    }
}
