...
namespace EFDL
{
    ...
    public partial class tbl_T_Smjestaj_privremeni
    {
        public tbl_T_Smjestaj_privremeni()
        {
            this.tbl_Predmeti_u_zbirkama = new HashSet<tbl_Predmeti_u_zbirkama>();
        }
        ...
        public virtual ICollection<tbl_Predmeti_u_zbirkama> tbl_Predmeti_u_zbirkama { get; set; }
    }
}
